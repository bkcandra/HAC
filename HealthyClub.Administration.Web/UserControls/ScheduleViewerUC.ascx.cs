...
{
    public partial class ScheduleViewerUC : System.Web.UI.UserControl
    {
        ...
        {
            var SchedulesDT = new AdministrationDAC().RetrieveActivitySchedules(ActivityID);
            if (SchedulesDT != null)
            {
            ...
            else
            {
                ...
                lblNoTimetable.Text = "No Timetable was given for this activity, for more information contact the activity provider.";
            }
        }

        public void InitTimetablePreview(AdministrationEDSC.ActivityScheduleDTDataTable dt)
        {
        ...
        private List<List<slot>> CreateSeasonalTimetable(AdministrationEDSC.ActivityScheduleDTDataTable SchedulesDT)
        {
        ...
        protected void ListView1_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            ScheduleDetailViewerUC scslot = e.Item.FindControl("ScheduleDetailViewerUC1") as ScheduleDetailViewerUC;
