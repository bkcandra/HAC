...
<asp:UpdatePanel ID="UpdatePanelTimetable" runat="server" UpdateMode="Always" EnableViewState="true">
    <ContentTemplate>
        <asp:HiddenField ID="hdnEdit" runat="server" />
        <asp:HiddenField ID="hdnActivityID" runat="server" />
        <asp:Label ID="Label1" runat="server" Text="In this section you can provide details to Club Members about when your activity is run.&nbsp;&nbsp;You can choose to add a timetable or have Club Members contact your directly for your activity details."></asp:Label>
        <hr />
        ...
        <div id="divTimetable" runat="server">
            <fieldset style="width:80%">
                <legend>
                    <strong>Timetable details</strong><br />
                    You can add multiple timetables for your activity by repeating the following steps and clicking add timetable again.
                </legend>
<table>
                <tr>
                ...
                <tr>
                    <td class="style1">
                        <asp:TextBox ID="txtCalendarFrom" runat="server" 
                           ></asp:TextBox>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:TextBox ID="txtEndDate" runat="server" ToolTip="You will receive notification to update you activity on this date"
                            ></asp:TextBox>
                ...
                <tr>
                    <td align="center">
                        <asp:Label ID="lblError" runat="server" Text="" Style="text-align: left; color: #FF0000;"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" Text="Add Timetable" />
                    </td>
                </tr>
            </table>
            </fieldset>
            ...
            <br />
            <div id="divFullTimetable" runat="server">
                <div style="margin: 10px 0">
                ...
                <asp:CheckBox ID="chkFullTimetable" runat="server" Text="See Full Timetable" AutoPostBack="true"
                    OnCheckedChanged="chkFullTimetable_CheckedChanged" Visible="true" />
                <br />
                <div style="margin: 10px 0">
