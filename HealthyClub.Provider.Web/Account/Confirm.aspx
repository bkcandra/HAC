<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Confirm.aspx.cs" Inherits="HealthyClub.Provider.Web.Account.ConfirmAccount" %>
    ...
    <div id="CompleteConfirm" runat="server" visible="false">
        <table style="font-family: Verdana; font-size: 100%; width: 800px; margin: 20px auto">
            ...
            <tr>
                ...
                <br />
                    <br />
                    Click continue to log in and start listing your healthy activities. </td>
            </tr>
            <tr>
                <td align="right">
