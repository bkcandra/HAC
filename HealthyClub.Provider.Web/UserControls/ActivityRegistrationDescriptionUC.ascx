<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ActivityRegistrationDescriptionUC.ascx.cs"
    Inherits="HealthyClub.Providers.Web.UserControls.ActivityRegistrationDescription" %>
...
<script>
    function load() {
        ("div.main_Desc").reload();
    }
</script>
<asp:UpdatePanel ID="UpdatePaneldesc" runat="server">
    <ContentTemplate>
        <div id="main_Desc" class="description">
            <span class="labelTitle">How do you categorise your activity and what is the cost?</span><br />
            Step 1.&nbsp;&nbsp;Select up to 5 main and sub categories<br />
            Step 2.&nbsp;&nbsp;Click the "Add Category" button to confirm category selection<br />
            Step 3.&nbsp;&nbsp;Repeat the process to add more main categories<br />
            <hr />
            <table style="width: 100%">
                <tr>
                    <td class="style1" style="padding: 6px">Activity Category<span style="color: Red">*</span></td>
                    <td class="style2">&nbsp;
                    </td>
                    <td>
                ...
                <tr id="trEligibility1" runat="server" visible="false">
                    <td class="style1">Requirements</td>
                    <td class="style2">&nbsp;
                    </td>
                    <td>
            ...
            <div id="tableFees" runat="server">
                ...
                Include details such as the cost of individual sessions, package deals and special promotions.
                <hr />
                <table>
            ...
            <div style="width: 100%">
                ...
                <span class="style3">This is where you can promote your activity and include background
