<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ActivitiesListView.ascx.cs"
    Inherits="HealthyClub.Web.UserControls.ActivitiesListView" %>
<%@ Register Src="~/UserControls/ScheduleViewerUC.ascx" TagPrefix="uc1" TagName="ScheduleViewerUC" %>
<%@ Register Src="ActivityListingNavigation.ascx" TagName="ActivityListingNavigation" TagPrefix="uc2" %>
<script>
    ...
    <tr>
        <td style="width: 60%">Sort by&nbsp;
            <asp:DropDownList ID="ddSort" runat="server" Width="225px" CssClass="limitOptions bodyText1" Style="height: 24px"
                ...
                <asp:ListItem Value="4">Activity title: A - Z</asp:ListItem>
                <asp:ListItem Value="5">Activity title: Z - A</asp:ListItem>
...
<asp:Label ID="lbltimerefine" runat="server" Text="" Visible="false"></asp:Label>
<br />
<asp:Label ID="lblshowres" runat="server" Text="" Visible="false"></asp:Label>
<br />
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <div id="divActivitiesListViewContent" runat="server" style="width: 100%">
