<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImagesListViewUC.ascx.cs"
    Inherits="HealthyClub.Web.UserControls.ImagesListViewUC" %>
...
<div id="gallery" class="ad-gallery">
    <asp:Image ID="imgNoImage" Visible="false" runat="server" Style="max-height: 300px; max-width: 300px" />
                            ...
                            <li>
                                <asp:HyperLink ID="hlnkgal2" runat="server">
                                    <asp:Image ID="imgGal2" runat="server" title='<%#Eval("ImageTitle") %>' AlternateText='<%#Eval("Description") %>'
                                        Style="vertical-align: middle; text-align: center; max-height: 50px" />
                                </asp:HyperLink>
                            </li>
                            ...
                            <li>
                                <asp:HyperLink ID="hlnkgal1" runat="server" Style="display: none">
                                    <asp:Image ID="imgGal1" runat="server" title='<%#Eval("ImageTitle") %>' AlternateText='<%#Eval("Description") %>'
                                        Style="vertical-align: middle; text-align: center; max-height: 50px; display: none" />
                                </asp:HyperLink>
                            </li>
