<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AccountRemovalUC.ascx.cs" Inherits="HealthyClub.Customer.Web.UserControls.AccountRemovalUC" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <asp:HyperLink ID="hlnkContactUs" runat="server" NavigateUrl="~/ContactUs/">here</asp:HyperLink>
            ...
            <br /><br />
            <asp:CheckBox ID="chkRemoveAccount" runat="server" AutoPostBack="true" Text="Yes, I want to permanently delete my Club Member account." OnCheckedChanged="chkRemoveAccount_CheckedChanged" />
            <p>
