<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="HealthyClub.Customer.Web.Account.OpenAuthProviders" %>
<p>
    <asp:Label runat="server" ID="lblAlertMsg" />

</p>
<fieldset class="open-auth-providers">
    <legend>Log in using another account</legend>
