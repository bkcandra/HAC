<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PasswordRecovery.aspx.cs" Inherits="HealthyClub.Customer.Web.Account.PasswordRecovery" %>
                ...
                <br />
                    ...
                    <div style="padding: 10px;">
                        <div style="width: 450px;">
                            ...
                            <asp:TextBox ID="txtNewPassword" runat="server" Width="200px" Style="height: 25px; border: 1px solid #cccccc"></asp:TextBox>
                            <br />
                            ...
                            <asp:TextBox ID="txtVerifyNewPassword" runat="server" Width="200px" Style="height: 25px; border: 1px solid #cccccc"></asp:TextBox>
                            <br />
            ...
            <tr>
                <td align="right">
                    <asp:Button ID="ContinueButton" runat="server"
                        BackColor="#499ECA" BorderColor="#499ECA"
                        BorderStyle="Solid" BorderWidth="0px" CausesValidation="False" CommandName="Continue" Width="80px"
                        Font-Names="Verdana" ForeColor="White" Height="28px" Text="Continue"
                        ValidationGroup="CreateNewProvider"
                    ...
                    &nbsp;<asp:Button ID="Home" runat="server" BackColor="#499ECA" BorderColor="#499ECA"
                        ...
                        Font-Names="Verdana" ForeColor="White" Height="28px"
