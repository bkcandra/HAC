<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="HealthyClub.Customer.Web.Account.ForgotPassword" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="PasswordRecoveryComplete" runat="server" visible="false">
        <table style="font-family: Verdana; font-size: 100%; width: 800px; margin: 20px auto">
            ...
            <tr>
                <td style="padding: 10px;"><span>An email has been sent to '<asp:Label ID="lblEmail" runat="server" Text="" Font-Bold="true"></asp:Label>' with instructions on how to change your password. Please check your email inbox.
                </span></td>
            </tr>
            <tr>
                <td align="right">
