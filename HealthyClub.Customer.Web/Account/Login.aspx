<%@ Page Title="Log in" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="HealthyClub.Customer.Web.Account.Login" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div style="padding: 20px">
        <a class="pageTitle">Sign in or Register as a Club Member </a>
        <br />
