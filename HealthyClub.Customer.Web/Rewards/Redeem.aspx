<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Redeem.aspx.cs" Inherits="HealthyClub.Customer.Web.Rewards.Redeem" %>

<%@ Register Src="../UserControls/RewardCheckout.ascx" TagName="RewardCheckout" TagPrefix="uc1" %>
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
    ...
    <div id="RewardsMenu">
        <div id="RewardsMenuNav">
            <ul>
                ...
                <li id="HouseMenuNav2Link5" class="CurrentItem"><a href="Redeem" title="Redeem Points" tabindex="1">Redeem Points</a></li>
    ...
    <div id="sidetext">
        <uc1:RewardCheckout ID="RewardCheckout" runat="server" />
    </div>
