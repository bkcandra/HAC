<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Rewards.aspx.cs" Inherits="HealthyClub.Customer.Web.Rewards.Rewards" %>

<%@ Register Src="../UserControls/RewardDetail.ascx" TagName="RewardDetail" TagPrefix="uc1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="sidetext">
        <uc1:RewardDetail ID="RewardDetail1" runat="server" />
    </div>
</asp:Content>
